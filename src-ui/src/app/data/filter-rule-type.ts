...
export const FILTER_CABINET = 50
export const FILTER_HAS_CABINET_ANY = 51
export const FILTER_DOES_NOT_HAVE_CABINET = 52
...
export const FILTER_RULE_TYPES: FilterRuleType[] = [
  ...
  {
    id: FILTER_CABINET,
    filtervar: 'cabinet__id',
    isnull_filtervar: 'cabinet__isnull',
    datatype: DataType.Cabinet,
    multi: false,
  },
  {
    id: FILTER_HAS_CABINET_ANY,
    filtervar: 'cabinet__id__in',
    datatype: DataType.Cabinet,
    multi: true,
  },
  {
    id: FILTER_DOES_NOT_HAVE_CABINET,
    filtervar: 'cabinet__id__none',
    datatype: DataType.Cabinet,
    multi: true,
  },
  {
