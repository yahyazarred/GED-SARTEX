...
import { CabinetListComponent } from './management-list/cabinet-list/cabinet-list.component'
...
export class DocumentAttributesComponent implements OnInit, OnDestroy {
  ...
  readonly sections: DocumentAttributesSection[] = [
    ...
    {
      id: DocumentAttributesNavIDs.Cabinets,
      path: 'cabinets',
      label: $localize`Cabinets`,
      icon: 'archive',
      permissionType: PermissionType.Cabinet,
      kind: DocumentAttributesSectionKind.ManagementList,
