...
from documents.views import SignedDocumentViewSet
...
api_router.register(r"cabinets", CabinetViewSet)
...
api_router.register(r"signed_documents", SignedDocumentViewSet, basename="signed-document")
