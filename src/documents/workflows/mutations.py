...
def apply_assignment_to_document(
    ...
    if action.assign_cabinet:
        document.cabinet = action.assign_cabinet
        document.inherit_cabinet_permissions = action.assign_inherit_cabinet_permissions
...
def apply_assignment_to_overrides(
    ...
    if action.assign_cabinet:
        overrides.cabinet_id = action.assign_cabinet.pk
        overrides.inherit_cabinet_permissions = (
            action.assign_inherit_cabinet_permissions
        )
...
def apply_removal_to_document(
    ...
    if action.remove_all_cabinets or (
        document.cabinet
        and action.remove_cabinets.filter(pk=document.cabinet.pk).exists()
    ):
        document.cabinet = None
        document.inherit_cabinet_permissions = False
...
def apply_removal_to_overrides(
    ...
    if action.remove_all_cabinets or (
        overrides.cabinet_id
        and action.remove_cabinets.filter(pk=overrides.cabinet_id).exists()
    ):
        overrides.cabinet_id = None
        overrides.inherit_cabinet_permissions = False
