...
class DocumentMetadataOverrides:
    ...
    inherit_cabinet_permissions: bool | None = None
    ...
    def update(self, other: "DocumentMetadataOverrides") -> "DocumentMetadataOverrides":
        ...
        if other.cabinet_id is not None:
            self.cabinet_id = other.cabinet_id
        if other.inherit_cabinet_permissions is not None:
            self.inherit_cabinet_permissions = other.inherit_cabinet_permissions
    ...
    def from_document(doc) -> "DocumentMetadataOverrides":
        ...
        overrides.cabinet_id = doc.cabinet.id if doc.cabinet else None
        overrides.inherit_cabinet_permissions = doc.inherit_cabinet_permissions
