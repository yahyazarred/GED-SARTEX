...
class CabinetFilterSet(FilterSet):
    class Meta:
        model = Cabinet
        fields = {
            "id": ID_KWARGS,
...
class DocumentFilterSet(FilterSet):
    ...
    cabinet__id__none = ObjectFilter(field_name="cabinet", exclude=True)
    ...
    class Meta:
        ...
        fields = {
            ...
            "cabinet": ["isnull"],
            "cabinet__id": ID_KWARGS,
            "cabinet__name": CHAR_KWARGS,
            "inherit_cabinet_permissions": ["exact"],
            "owner": ["isnull"],
            "owner__id": ID_KWARGS,
