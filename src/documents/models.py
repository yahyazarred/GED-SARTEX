...
class Document(SoftDeleteModel, ModelWithOwner):  # type: ignore[django-manager-missing]
    ...
    inherit_cabinet_permissions = models.BooleanField(
        _("inherit cabinet permissions"),
        default=True,
        help_text=_(
            "Use the cabinet's view and change permissions instead of the "
...
class WorkflowTrigger(models.Model):
    ...
    filter_has_cabinet = models.ForeignKey(
        Cabinet,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        verbose_name=_("belongs to this cabinet"),
    )

    filter_has_any_cabinets = models.ManyToManyField(
        Cabinet,
        blank=True,
        related_name="workflowtriggers_has_any_cabinet",
        verbose_name=_("belongs to one of these cabinets"),
    )

    filter_has_not_cabinets = models.ManyToManyField(
        Cabinet,
        blank=True,
        related_name="workflowtriggers_has_not_cabinet",
        verbose_name=_("does not belong to these cabinet(s)"),
    )
...
class WorkflowAction(models.Model):
    ...
    assign_cabinet = models.ForeignKey(
        Cabinet,
        null=True,
        blank=True,
        on_delete=models.SET_NULL,
        related_name="+",
        verbose_name=_("assign this cabinet"),
    )

    assign_inherit_cabinet_permissions = models.BooleanField(
        default=True,
        verbose_name=_("inherit permissions from the assigned cabinet"),
    )
    ...
    remove_cabinets = models.ManyToManyField(
        Cabinet,
        blank=True,
        related_name="+",
        verbose_name=_("remove these cabinet(s)"),
    )

    remove_all_cabinets = models.BooleanField(
        default=False,
        verbose_name=_("remove all cabinets"),
    )
